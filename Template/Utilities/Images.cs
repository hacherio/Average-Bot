...
namespace Template.Utilities
{
    public class Images
    {
        public async Task<string> CreateImageAsync(SocketGuildUser user)
        {
            ...
            var background = await FetchImageAsync("https://images.unsplash.com/photo-1519810755548-39cd217da494?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80");
        ...
        private Image CopyRegionIntoImage(Image source, Image destination) 
        {
            ...
            var y = (destination.Height / 2) - 115;
        ...
        {
            var ubuntu = new Font("ubuntu", 30, FontStyle.Regular);
            var ubuntuSmall = new Font("ubuntu", 23, FontStyle.Regular);
            ...
            GrD.DrawString(header, ubuntu, brushWhite, headerX, headerY, drawFormat);
            GrD.DrawString(header, ubuntu, brushGrey, subheaderX, subheaderY, drawFormat);
        ...
        private async Task<Image> FetchImageAsync(string url)
        {
            ...
            {
                var backupResponse = await client.GetAsync("https://images.unsplash.com/photo-1519810755548-39cd217da494?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80");
